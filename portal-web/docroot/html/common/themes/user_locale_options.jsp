...
<c:if test="<%= !locale.equals(user.getLocale()) %>">
	...
	boolean allowCompanyLocalesInSiteAdmin = PrefsPropsUtil.getBoolean(company.getCompanyId(), PropsKeys.LOCALE_ALLOW_COMPANY_LOCALES_IN_SITE_ADMIN, PropsValues.LOCALE_ALLOW_COMPANY_IN_SITE_ADMIN);
	%>
